 ...
 * 
 * Usage:
 *   node sanitize-db.js --session-id=123 --source-db=orthodoxmetrics_db --target-db=orthodoxmetrics_dev_db
 ...
 * - Domain replacement (orthodoxmetrics.com → orthodmetrics.com)
...
class DatabaseSanitizer {
    constructor(config = {}) {
        this.config = {
            ...
            trackingDatabase: config.trackingDatabase || 'omai_spin_dev_db',
            
            // Sanitization settings
            devDomain: config.devDomain || 'devtest.local',
            devUrlPrefix: config.devUrlPrefix || 'http://orthodmetrics.com',
    ...
    sanitizeDomain(domain) {
        ...
        if (domain.includes('orthodoxmetrics.com')) {
            ...
            return domain.replace('orthodoxmetrics.com', 'orthodmetrics.com');
        }
...
Examples:
  node sanitize-db.js --session-id=456 --source-db=orthodoxmetrics_db --target-db=orthodoxmetrics_dev_db
