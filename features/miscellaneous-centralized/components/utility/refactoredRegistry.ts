...
export const REFACTORED_ROUTES: RefRoute[] = [
  ...
  { path: "refactored-6/public-assign-task",        importPath: "@/views/pages/AssignTask",                                            label: "Public Task Assignment",    icon: "Task" },
  ...
  { path: "duplicate/profile-tab",     importPath: "@/views/apps/user-profile/UserProfile",                                 label: "ProfileTab",               icon: "User" },
  { path: "duplicate/profile-tab-backup1", importPath: "@/views/apps/user-profile/UserProfile",                             label: "ProfileTab (Backup 1)",     icon: "User" },
  { path: "duplicate/profile-tab-backup2", importPath: "@/views/apps/user-profile/UserProfile",                             label: "ProfileTab (Backup 2)",     icon: "User" },
  { path: "duplicate/profile-tab-backup3", importPath: "@/views/apps/user-profile/UserProfile",                             label: "ProfileTab (Backup 3)",     icon: "User" },
  { path: "duplicate/user-profile",   importPath: "@/views/apps/user-profile/UserProfile",                                   label: "UserProfile",               icon: "User" },
  { path: "duplicate/user-profile-backup1", importPath: "@/views/apps/user-profile/UserProfile",                           label: "UserProfile (Backup 1)",   icon: "User" },
  { path: "duplicate/user-profile-backup2", importPath: "@/views/apps/user-profile/UserProfile",                           label: "UserProfile (Backup 2)",   icon: "User" },
  { path: "duplicate/gallery",        importPath: "@/views/apps/user-profile/Gallery",                                        label: "Gallery",                  icon: "Image" },
  { path: "duplicate/gallery-backup1", importPath: "@/views/apps/user-profile/Gallery",                                      label: "Gallery (Backup 1)",        icon: "Image" },
  { path: "duplicate/gallery-backup2", importPath: "@/views/apps/user-profile/Gallery",                                      label: "Gallery (Backup 2)",        icon: "Image" },
  { path: "duplicate/friends",        importPath: "@/views/apps/user-profile/Friends",                                        label: "Friends",                  icon: "Users" },
  { path: "duplicate/friends-backup1", importPath: "@/views/apps/user-profile/Friends",                                      label: "Friends (Backup 1)",        icon: "Users" },
  { path: "duplicate/friends-backup2", importPath: "@/views/apps/user-profile/Friends",                                      label: "Friends (Backup 2)",        icon: "Users" },
  { path: "duplicate/followers",      importPath: "@/views/apps/user-profile/Followers",                                      label: "Followers",                icon: "Users" },
  { path: "duplicate/followers-backup1", importPath: "@/views/apps/user-profile/Followers",                                  label: "Followers (Backup 1)",     icon: "Users" },
  { path: "duplicate/followers-backup2", importPath: "@/views/apps/user-profile/Followers",                                  label: "Followers (Backup 2)",     icon: "Users" },
];
...
export const REFACTORED_IMPORTS: Record<string, ReturnType<typeof lazy>> = {
  ...
  "refactored-6/public-assign-task":        lazy(() => import("@/views/pages/AssignTask")),
  ...
  // 🔄 DUPLICATE Components (Multiple Locations) - Only existing components
  "duplicate/profile-tab":     lazy(() => import("@/views/apps/user-profile/UserProfile")),
  "duplicate/profile-tab-backup1": lazy(() => import("@/views/apps/user-profile/UserProfile")),
  "duplicate/profile-tab-backup2": lazy(() => import("@/views/apps/user-profile/UserProfile")),
  "duplicate/profile-tab-backup3": lazy(() => import("@/views/apps/user-profile/UserProfile")),
  "duplicate/user-profile":   lazy(() => import("@/views/apps/user-profile/UserProfile")),
  "duplicate/user-profile-backup1": lazy(() => import("@/views/apps/user-profile/UserProfile")),
  "duplicate/user-profile-backup2": lazy(() => import("@/views/apps/user-profile/UserProfile")),
  "duplicate/gallery":        lazy(() => import("@/views/apps/user-profile/Gallery")),
  "duplicate/gallery-backup1": lazy(() => import("@/views/apps/user-profile/Gallery")),
  "duplicate/gallery-backup2": lazy(() => import("@/views/apps/user-profile/Gallery")),
  "duplicate/friends":        lazy(() => import("@/views/apps/user-profile/Friends")),
  "duplicate/friends-backup1": lazy(() => import("@/views/apps/user-profile/Friends")),
  "duplicate/friends-backup2": lazy(() => import("@/views/apps/user-profile/Friends")),
  "duplicate/followers":      lazy(() => import("@/views/apps/user-profile/Followers")),
  "duplicate/followers-backup1": lazy(() => import("@/views/apps/user-profile/Followers")),
  "duplicate/followers-backup2": lazy(() => import("@/views/apps/user-profile/Followers")),
};
