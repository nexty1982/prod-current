...
# Location: /var/www/orthodox-church-mgmt/orthodmetrics/prod/front-end

# Exit on error
set -e

# Config
FRONTEND_DIR="/var/www/orthodox-church-mgmt/orthodmetrics/prod/front-end"
BUILD_LOG="/var/log/orthodmetrics/front-end_build.log"
