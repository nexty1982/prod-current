    ...
    <section className="py-16 md:py-20 bg-[#2d1b4e] dark:bg-[#0d1117] text-white">
      <div className="max-w-6xl mx-auto px-4 md:px-6">
        ...
        <div className="text-center mb-10 md:mb-12">
          ...
          <EditableText contentKey="records.subtitle" as="p" className="font-om-body text-white/70 dark:text-white/55 max-w-2xl mx-auto text-base md:text-lg" multiline>
