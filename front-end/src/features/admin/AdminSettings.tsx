...
import OMBigBook from './OMBigBook';
import OmaiSpinSettings from './OmaiSpinSettings';
import ComponentManager from './components/ComponentManager';
import SettingsConsole from './dashboard/SettingsConsole';
...
// Map URL ?tab= param names to tab indices
...
const AdminSettings: React.FC = () => {
    ...
    const initialTab = useMemo(() => {
        ...
        return t && TAB_MAP[t] !== undefined ? TAB_MAP[t] : 0;
    }, []);
