...
const TOOLS: FeatureCard[] = [
  ...
  {
    title: 'OCR Pipeline',
    description: 'Track digitization of historical ledgers from upload to database commit',
    to: '/portal/ocr',
    icon: IconScan,
    roles: ['super_admin', 'admin', 'church_admin', 'priest'],
    color: '#3a3a3a',
    gradient: 'linear-gradient(135deg, #ededed 0%, #d5d5d5 100%)',
  },
  {
    title: 'Parish Charts',
  ...
  {
    title: 'Sacramental Restrictions',
    description: 'View date restrictions for baptisms, marriages, and funerals',
    to: '/portal/sacramental-restrictions',
    icon: IconCalendarOff,
    color: '#444444',
    gradient: 'linear-gradient(135deg, #f0f0f0 0%, #d8d8d8 100%)',
  },
];
