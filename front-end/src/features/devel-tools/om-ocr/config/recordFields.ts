...
export const RECORD_FIELDS: Record<string, FieldDefinition[]> = {
  baptism: [
    ...
    { name: 'notes', label: 'Notes', required: false, type: 'textarea', headerLabel: 'NOTES', visible: false, sortOrder: 11 },
  ],
  marriage: [
    { name: 'record_number', label: 'Record #', required: false, type: 'text', headerLabel: 'NUMBER', visible: true, sortOrder: 0 },
    { name: 'groom_name', label: 'Groom Name', required: true, type: 'text', headerLabel: 'GROOM', visible: true, sortOrder: 1 },
    { name: 'bride_name', label: 'Bride Name', required: true, type: 'text', headerLabel: 'BRIDE', visible: true, sortOrder: 2 },
    { name: 'date_of_marriage', label: 'Date of Marriage', required: true, type: 'date', headerLabel: 'DATE OF MARRIAGE', visible: true, sortOrder: 3 },
    { name: 'place_of_marriage', label: 'Place of Marriage', required: false, type: 'text', headerLabel: 'PLACE OF MARRIAGE', visible: true, sortOrder: 4 },
    { name: 'witnesses', label: 'Witnesses', required: false, type: 'text', headerLabel: 'WITNESSES', visible: true, sortOrder: 5 },
    { name: 'best_man', label: 'Best Man', required: false, type: 'text', headerLabel: 'BEST MAN', visible: false, sortOrder: 6 },
    { name: 'maid_of_honor', label: 'Maid of Honor', required: false, type: 'text', headerLabel: 'MAID OF HONOR', visible: false, sortOrder: 7 },
    ...
    { name: 'notes', label: 'Notes', required: false, type: 'textarea', headerLabel: 'NOTES', visible: false, sortOrder: 10 },
  ],
  funeral: [
    { name: 'record_number', label: 'Record #', required: false, type: 'text', headerLabel: 'NUMBER', visible: true, sortOrder: 0 },
