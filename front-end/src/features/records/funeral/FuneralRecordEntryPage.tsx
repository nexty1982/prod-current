      ...
      const loadRecord = async () => {
        try {
          ...
          if (data.success && data.record) {
            ...
            // Handle both field name variations (priest_name vs clergy)
            setFormData({
              ...
              age_at_death: record.age_at_death?.toString() || '',
              priest_name: record.priest_name || record.priest || record.clergy || '',
              notes: record.notes || ''
            });
          }
        } catch (err: any) {
    ...
    try {
      ...
      const response = await fetch(`${url}?${params.toString()}`, {
        ...
        body: JSON.stringify({
          ...
          age_at_death: formData.age_at_death ? parseInt(formData.age_at_death) : null
        })
      });
