      ...
      const loadRecord = async () => {
        try {
          ...
          if (data.success && data.record) {
            ...
            setFormData({
              groom_first_name: record.groom_first_name || '',
              groom_last_name: record.groom_last_name || '',
              bride_first_name: record.bride_first_name || '',
              bride_last_name: record.bride_last_name || '',
              marriage_date: record.marriage_date || '',
              clergy: record.clergy || '',
              witnesses: record.witnesses || '',
              marriage_place: record.marriage_place || '',
              notes: record.notes || ''
            });
          }
        } catch (err: any) {
