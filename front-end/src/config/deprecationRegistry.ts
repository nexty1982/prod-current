...
export const DEPRECATION_REGISTRY: DeprecatedEntry[] = [
  ...
  // ── Stage 1: Deprecated (routes redirect, files on disk) ──
  {
    id: 'crm-page',
    name: 'CRM Page',
    stage: 1,
    ...
    reason: 'Church lifecycle feature retired from OM, now owned by OMAI (PP-0003)',
    deprecatedDate: '2026-03-15',
    owner: 'nectarios',
  ...
  },
  {
    ...
    replacement: '/admin/control-panel (church lifecycle retired to OMAI)',
    reason: 'CRM Outreach category sub-page retired from OM, church lifecycle now owned by OMAI (PP-0003)',
    deprecatedDate: '2026-03-15',
    owner: 'nectarios',
  ...
  {
    id: 'church-lifecycle-detail-page',
    name: 'Church Lifecycle Detail Page',
    stage: 1,
    files: ['features/admin/control-panel/ChurchLifecycleDetailPage.tsx'],
    replacement: 'OMAI ops/church-lifecycle (route kept for OMAI window.open consumption)',
    reason: 'Church lifecycle feature retired from OM, now owned by OMAI. Detail route remains because OMAI opens it via window.open (PP-0003)',
    deprecatedDate: '2026-03-24',
    owner: 'nectarios',
