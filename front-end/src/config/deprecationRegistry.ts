...
export const DEPRECATION_REGISTRY: DeprecatedEntry[] = [
  ...
  // ── Stage 1: Deprecated (routes redirect, files on disk) ──
  {
    ...
    reason: 'Replaced by unified Church Lifecycle Management page (PP-0003)',
    deprecatedDate: '2026-03-15',
    owner: 'nectarios',
  ...
  },
  {
    ...
    reason: 'Replaced by unified Church Lifecycle Detail page (PP-0003)',
    deprecatedDate: '2026-03-15',
    owner: 'nectarios',
  ...
  },
  {
    ...
    replacement: '/admin/control-panel/church-lifecycle',
    reason: 'CRM Outreach category sub-page links updated to Church Lifecycle (PP-0003)',
    deprecatedDate: '2026-03-15',
    owner: 'nectarios',
