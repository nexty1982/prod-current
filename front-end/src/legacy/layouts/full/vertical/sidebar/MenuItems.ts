...
const Menuitems: MenuitemsType[] = [
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        icon: IconDatabase,
  IconGauge,
        href: '/apps/church-management/:id/field-mapper',
      },
    ],
  },
  {
  ...
  IconGauge,
      ...
      },
      {
        ...
        icon: IconBorderAll,
        href: '/apps/../features/records/records/centralized',
        chip: 'UNIFIED',
        chipColor: 'success',
      },
    ],
  ...
  IconGauge,
      ...
      {
        id: uniqueId(),
        title: "Church Tools Preview",
        icon: IconLayoutTemplate,
        href: "/devel/church-tools",
      },
      {
        id: uniqueId(),
...
export const getMenuItems = (user: any) => {
          ...
          children: item.children.map(child => {
            switch (child.title) {
              case 'Dynamic Explorer':
                return { ...child, href: `/apps/../features/records/records/dynamic/${churchId}` };
              case 'Enhanced AG Grid':
                return { ...child, href: `/apps/../features/records/records/enhanced/${churchId}` };
              case 'Simple Church Records':
                return { ...child, href: `/apps/records-simple/${churchId}` };
              case 'Dynamic Manager':
                return { ...child, href: `/apps/../features/records/records/manager` };
              case 'Modern Manager':
                return { ...child, href: `/apps/../features/records/records/modern-manager` };
              case 'Editable Records':
                return { ...child, href: `/apps/../features/records/records/editable` };
              default:
                return child;
            }
          })
  ...
  // For non-admin users, show simplified menu with basic functionality
  return [
    {
      navlabel: true,
      subheader: '📊 Dashboards',
      ...
      children: [
        {
          ...
          icon: IconDatabase,
  IconGauge,
          href: `/apps/../features/records/records/dynamic/${churchId}`,
        },
        {
          id: uniqueId(),
  ...
  IconGauge,
        ...
        },
        {
          ...
          title: 'Enhanced Grid',
          icon: IconBorderAll,
          href: `/apps/../features/records/records/enhanced/${churchId}`,
        },
        {
          id: uniqueId(),
          title: 'Baptism Records',
          icon: IconFileDescription,
          href: '/apps/../features/records/records/baptism',
        },
        {
          id: uniqueId(),
          title: 'Marriage Records',
          icon: IconFileDescription,
          href: '/apps/../features/records/records/marriage',
        },
        {
          id: uniqueId(),
          title: 'Funeral Records',
          icon: IconFileDescription,
          href: '/apps/../features/records/records/funeral',
        },
      ],
    },
    {
