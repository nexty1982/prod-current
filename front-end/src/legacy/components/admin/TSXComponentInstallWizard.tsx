...
const TSXComponentInstallWizard: React.FC<TSXComponentInstallWizardProps> = ({
  ...
  const [installOptions, setInstallOptions] = useState<InstallationOptions>({
    targetDirectory: 'src/shared/ui/legacy/',
  ...
  const [availableDirectories, setAvailableDirectories] = useState<string[]>([
    'src/shared/ui/legacy/',
    'src/@/features/admin/admin/',
    'src/shared/ui/legacy/shared/',
    'src/shared/ui/legacy/custom/',
    'src/pages/',
    'src/views/',
    'src/addons/'
  ]);
                ...
                <Switch
                  ...
                  onChange={(e) => {
                    ...
                    setInstallOptions(prev => ({ 
                      ...
                      targetDirectory: isEnabled ? 'src/shared/ui/legacy/bigbook/custom' : 'src/shared/ui/legacy/',
