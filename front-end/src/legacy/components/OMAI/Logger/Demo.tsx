...
import { OMAIUltimateLogger } from './OMAIUltimateLogger.tsx';
import { SimpleLogViewer } from './SimpleLogViewer.tsx';
 ...
 * 
 * import { Demo } from './shared/ui/legacy/OMAI/Logger/Demo';
 * 
 * function App() {
 *   return (
 *     <Routes>
