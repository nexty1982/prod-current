      ...
      children: [
        {
          ...
          path: 'src/shared/ui/legacy/church-management',
          type: 'directory',
          children: [
            {
              name: 'ch-wiz',
              path: 'src/shared/ui/legacy/church-management/ch-wiz',
              type: 'directory',
              children: [
                {
                  name: 'ChurchSetupWizard.tsx',
                  path: 'src/shared/ui/legacy/church-management/ch-wiz/ChurchSetupWizard.tsx',
                  type: 'file',
                  size: 31245,
        ...
        },
        {
          ...
          path: 'src/shared/ui/legacy/user-management',
          type: 'directory',
          children: [
            {
              name: 'usr-core',
              path: 'src/shared/ui/legacy/user-management/usr-core',
              type: 'directory',
              children: [
                {
                  name: 'UserManagement.tsx',
                  path: 'src/shared/ui/legacy/user-management/usr-core/UserManagement.tsx',
                  type: 'file',
                  size: 28456,
        ...
        {
          name: 'shared',
          path: 'src/shared/ui/legacy/shared',
          type: 'directory',
          children: [
            {
              name: 'Button.tsx',
              path: 'src/shared/ui/legacy/shared/Button.tsx',
              type: 'file',
              size: 8234,
            ...
            {
              name: 'FormField.tsx',
              path: 'src/shared/ui/legacy/shared/FormField.tsx',
              type: 'file',
              size: 15678,
