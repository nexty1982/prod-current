...
const MOCK_RESULTS: OmtraceRunResult[] = [
  {
    ...
    resolvedPath: 'src/shared/ui/legacy/church-management/ch-wiz/ChurchSetupWizard.tsx',
    direct: [
      'src/shared/ui/legacy/shared/FormField.tsx',
      'src/shared/ui/legacy/shared/Button.tsx',
      'src/utils/validation.ts',
      'src/services/churchService.ts'
    ],
    transitive: [
      'src/shared/ui/legacy/shared/Input.tsx',
      'src/shared/ui/legacy/shared/Label.tsx',
    ...
    refactorPlan: {
      from: 'src/shared/ui/legacy/church-management/ch-wiz/ChurchSetupWizard.tsx',
      to: 'src/shared/ui/legacy/church-management/ch-wiz/ChurchSetupWizard.tsx',
      domain: 'church',
      slug: 'ch-wiz'
    },
    stats: {
  ...
  },
  {
    ...
    direct: [
      'src/shared/ui/legacy/shared/DataTable.tsx',
      'src/shared/ui/legacy/shared/Modal.tsx',
      'src/services/userService.ts',
      'src/hooks/useUsers.ts'
    ],
    transitive: [
      'src/shared/ui/legacy/shared/Table.tsx',
      'src/shared/ui/legacy/shared/Pagination.tsx',
...
const MOCK_HISTORY: RefactorHistoryItem[] = [
  {
    ...
    entry: 'ChurchSetupWizard',
    from: 'src/shared/ui/legacy/ChurchSetupWizard.tsx',
    to: 'src/shared/ui/legacy/church-management/ch-wiz/ChurchSetupWizard.tsx',
    importUpdates: 12,
    result: 'success',
  ...
  },
  {
    ...
    to: 'src/shared/ui/legacy/user-management/usr-core/UserManagement.tsx',
    importUpdates: 8,
    result: 'success',
    refactorMdPath: 'refactor.md',
...
export const useOmtraceApi = () => {
  ...
  const runAnalysis = useCallback(async (targets: string[], flags: OmtraceRunFlags): Promise<OmtraceRunResult> => {
    ...
    if (target.toLowerCase().includes('church')) {
      ...
      return {
        entry: target,
        resolvedPath: `src/shared/ui/legacy/${target}/${target}.tsx`,
        direct: [`src/shared/ui/legacy/shared/Button.tsx`, `src/utils/helpers.ts`],
        stats: {
  ...
  const runRefactor = useCallback(async (target: string, options: RefactorRequest): Promise<RefactorResponse> => {
    ...
    return {
      from: `src/shared/ui/legacy/${target}.tsx`,
      to: `src/shared/ui/legacy/${domain}-management/${domain}-${slug}/${target}.tsx`,
      domain,
      slug: `${domain}-${slug}`,
