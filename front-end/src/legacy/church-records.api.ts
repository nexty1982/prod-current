...
class ApiClient {
  ...
  baptism = {
    ...
    getRecord: (id: number): Promise<BaptismRecord> =>
      this.request(`/baptism-../features/records/records/${id}`),
    ...
    deleteRecord: (id: number): Promise<{ success: boolean; message: string }> =>
      this.request(`/baptism-../features/records/records/${id}`, { method: 'DELETE' }),

    importRecords: (
      file: File,
      onProgress?: (progress: FileUploadProgress) => void
    ): Promise<{ success: boolean; imported: number; errors: string[] }> =>
      this.uploadFile('/baptism-../features/records/records/import', file, {}, onProgress),

    getHistory: (id: number): Promise<any[]> =>
      this.request(`/baptism-../features/records/records/${id}/history`),
  };
  ...
  marriage = {
    ...
    getRecord: (id: number): Promise<MarriageRecord> =>
      this.request(`/marriage-../features/records/records/${id}`),
    ...
    deleteRecord: (id: number): Promise<{ success: boolean; message: string }> =>
      this.request(`/marriage-../features/records/records/${id}`, { method: 'DELETE' }),

    importRecords: (
      file: File,
      onProgress?: (progress: FileUploadProgress) => void
    ): Promise<{ success: boolean; imported: number; errors: string[] }> =>
      this.uploadFile('/marriage-../features/records/records/import', file, {}, onProgress),
  };
  ...
  funeral = {
    ...
    getRecord: (id: number): Promise<FuneralRecord> =>
      this.request(`/funeral-../features/records/records/${id}`),
    ...
    deleteRecord: (id: number): Promise<{ success: boolean; message: string }> =>
      this.request(`/funeral-../features/records/records/${id}`, { method: 'DELETE' }),

    importRecords: (
      file: File,
      onProgress?: (progress: FileUploadProgress) => void
    ): Promise<{ success: boolean; imported: number; errors: string[] }> =>
      this.uploadFile('/funeral-../features/records/records/import', file, {}, onProgress),
  };
  ...
  utils = {
    ...
    exportData: (
      ...
      this.request(`/${type}-../features/records/records/export?format=${format}${this.buildQueryString(filters)}`),
  };
