...
const mockFileTree: FileNode[] = [
  {
    ...
    isOpen: true,
    children: [
      { id: '2', name: 'components', type: 'folder', path: 'src/shared/ui/legacy/', isOpen: true, children: [
        { id: '3', name: 'Header.tsx', type: 'tsx', path: 'src/shared/ui/legacy/Header.tsx' },
        { id: '4', name: 'Dashboard.tsx', type: 'tsx', path: 'src/shared/ui/legacy/Dashboard.tsx' },
        { id: '5', name: 'UserProfile.tsx', type: 'tsx', path: 'src/shared/ui/legacy/UserProfile.tsx' }
      ]},
