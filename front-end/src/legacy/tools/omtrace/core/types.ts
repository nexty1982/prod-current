...
export interface DepsIndex {
  ...
  stats: IndexStats;
  nodes: Array<{
    id: string;           // "src/shared/ui/legacy/.../File.tsx"
...
export interface Candidate {
  path: string;           // "src/shared/ui/legacy/.../File.tsx"
...
export interface RefactorPlan {
  from: string;           // "src/@/features/admin/admin/Component.tsx"
  to: string;             // "src/shared/ui/legacy/domain-management/slug/Component.tsx"
  domain: string;         // "user"
