...
import ComingSoon from '../shared/ui/legacy/shared/ComingSoon';
...
const PageEditor = Loadable(lazy(() => import('@/features/admin/admin/tools/PageEditor')));
...
const SessionManagement = Loadable(lazy(() => import('@/features/admin/admin/SessionManagement')));
const AdminLogs = Loadable(lazy(() => import('@/features/admin/admin/SessionManagement')));
...
const SiteEditor = Loadable(lazy(() => import('../shared/ui/legacy/SiteEditor')));
...
// Demos
const OrthodoxThemeDemo = Loadable(lazy(() => import('../shared/ui/legacy/demos/OrthodoxThemeDemo')));
...
// Records Pages
const SSPPOCRecordsPage = Loadable(lazy(() => import('../features/../features/records/records/../features/records/records/SSPPOCRecordsPage')));
const UnifiedRecordsPage = Loadable(lazy(() => import('../features/../features/records/records/../features/records/records/UnifiedRecordsPage')));
...
const ChurchRecordsPage = Loadable(lazy(() => import('../features/../features/records/records/../features/records/records/ChurchRecordsPage')));

// New Records Management (Shop Layout)
const RecordsManagement = Loadable(lazy(() => import('../features/../features/records/records/apps/../features/records/records/index')));

// Church Records UI (based on eco-product-list)
const ChurchRecordsList = Loadable(lazy(() => import('../features/../features/records/records/apps/records-ui/index')));
...
const MuiAutoComplete = Loadable(
  lazy(() => import('@/shared/ui/forms/elements/MuiAutoComplete')),
);
