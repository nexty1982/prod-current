...
import RecordList from '@/features/misc-legacy/apps/../features/records/records/recordGrid/RecordList';
import RecordSidebar from '@/features/misc-legacy/apps/../features/records/records/recordGrid/RecordSidebar';
