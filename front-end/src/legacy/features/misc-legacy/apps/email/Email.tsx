...
import EmailLists from '@/features/misc-legacy/apps/email/EmailList';
import EmailFilter from '@/features/misc-legacy/apps/email/EmailFilter';
import EmailSearch from '@/features/misc-legacy/apps/email/EmailSearch';
import EmailContent from '@/features/misc-legacy/apps/email/EmailContent';
