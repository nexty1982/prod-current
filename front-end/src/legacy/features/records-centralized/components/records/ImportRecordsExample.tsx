          ...
          <div className="border-t pt-6">
            ...
            <div className="bg-gray-50 p-4 rounded-lg">
              <p className="text-gray-700 mb-2">
                <strong>Endpoint:</strong> <code className="bg-gray-200 px-2 py-1 rounded">POST /api/../features/records/records/import</code>
              </p>
              <p className="text-gray-700 mb-2">
                <strong>Sample Endpoint:</strong> <code className="bg-gray-200 px-2 py-1 rounded">GET /api/../features/records/records/sample/:recordType</code>
              </p>
