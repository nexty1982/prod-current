// src/shared/ui/legacy/UserFormModal.tsx
...
import User from '@/shared/lib/userService';
...
const UserFormModal: React.FC<UserFormModalProps> = ({
    ...
    const getAvailableRoles = () => {
        const allRoles = [
            ...
            { value: 'editor', label: 'Editor', description: 'Can edit ../features/records/records/content' },
