 ...
 * - PATCH /api/admin/shared/ui/legacy/:id (toggle component status)
 * - GET /api/admin/shared/ui/legacy/:id/logs (fetch component logs)
 * - POST /api/admin/shared/ui/legacy/:id/test (run component diagnostics)
 * 
        ...
        <Box>
            ...
            {!canManageComponents ? (
                ...
                <Alert severity="success" sx={{ mb: 3 }}>
                    ...
                    <code>✅ PATCH /api/admin/shared/ui/legacy/:id</code> • 
                    <code>✅ GET /api/admin/shared/ui/legacy/:id/logs</code> • 
                    <code>✅ POST /api/admin/shared/ui/legacy/:id/test</code>
                </Alert>
            )}
