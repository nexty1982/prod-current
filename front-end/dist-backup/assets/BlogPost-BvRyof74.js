var x=(i,a,o)=>new Promise((r,c)=>{var p=e=>{try{n(o.next(e))}catch(d){c(d)}},l=e=>{try{n(o.throw(e))}catch(d){c(d)}},n=e=>e.done?r(e.value):Promise.resolve(e.value).then(p,l);n((o=o.apply(i,a)).next())});import{aJ as b,l as S,j as t,B as s,C,a0 as P,e as g,a_ as y,U as v,h as w,d as m,D as B}from"./index-Dgvcv9SG.js";import{r as h}from"./vendor-Dkfty7_r.js";import{C as f}from"./Container-BLaKfmEJ.js";import{P as I}from"./Person-vi_qmFAm.js";import{C as k}from"./CalendarToday-Ihf30Jda.js";const E=()=>{const{slug:i,id:a}=b(),o=S(),[r,c]=h.useState(null),[p,l]=h.useState(!0),[n,e]=h.useState(null);return h.useEffect(()=>{x(void 0,null,function*(){l(!0);try{yield new Promise(j=>setTimeout(j,500));const u={id:a?parseInt(a):1,slug:i||`post-${a||1}`,title:"Getting Started with OrthodoxMetrics",content:`
