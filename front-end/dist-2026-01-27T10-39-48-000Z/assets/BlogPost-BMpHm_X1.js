var x=(i,a,o)=>new Promise((r,c)=>{var p=e=>{try{n(o.next(e))}catch(d){c(d)}},l=e=>{try{n(o.throw(e))}catch(d){c(d)}},n=e=>e.done?r(e.value):Promise.resolve(e.value).then(p,l);n((o=o.apply(i,a)).next())});import{aK as b,l as S,j as t,B as s,C,$ as P,e as g,b8 as y,R as v,h as w,d as m,D as B}from"./index-CNFXvQ6i.js";import{r as h}from"./vendor-DgfDxsY7.js";import{C as f}from"./Container-B70uReER.js";import{P as I}from"./Person-CAQJjPj2.js";import{C as R}from"./CalendarToday-C1QXJgSN.js";const M=()=>{const{slug:i,id:a}=b(),o=S(),[r,c]=h.useState(null),[p,l]=h.useState(!0),[n,e]=h.useState(null);return h.useEffect(()=>{x(void 0,null,function*(){l(!0);try{yield new Promise(j=>setTimeout(j,500));const u={id:a?parseInt(a):1,slug:i||`post-${a||1}`,title:"Getting Started with OrthodoxMetrics",content:`
...
//# sourceMappingURL=BlogPost-BMpHm_X1.js.map
