...
class ChurchProvisioner {
  ...
  async addToGlobalRegistry(churchData) {
    const mainConnection = await mysql.createConnection({
      ...this.systemDbConfig,
      database: 'orthodmetrics_dev' // Use the correct main system database
    });
    ...
    try {
      ...
      console.log('Inserting into orthodmetrics_dev.churches:', insertQuery, values);
      const [result] = await mainConnection.execute(insertQuery, values);
      console.log('Insert result:', result);
      console.log('✅ Church added to global registry (orthodmetrics_dev)');
    } finally {
