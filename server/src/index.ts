...
const omSeedlingsRouter = require('./routes/admin/omSeedlings');
...
app.use('/api/admin/om-seedlings', omSeedlingsRouter); // OM Seedlings engine (dry-run + execute)
...
console.log('✅ [Server] Mounted records-inspector, seed-records, om-seedlings, record-wizard, and ai-admin routes');
