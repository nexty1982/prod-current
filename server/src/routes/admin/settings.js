...
const { getEffectiveSetting, invalidateSettingCache, _settingsCache } = require('../../utils/settingsHelper');

const requireSuperAdmin = requireRole(['super_admin']);

// Export helper for other server modules (legacy accessor)
...
router.put('/', requireAuth, requireSuperAdmin, async (req, res) => {
    try {
        ...
        // Invalidate cache
        invalidateSettingCache(key, scopeId);
