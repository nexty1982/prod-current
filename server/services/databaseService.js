 ...
 * - orthodmetrics_dev: All platform data (users, churches, OCR, settings)
 * - Church-specific DBs: Only record data (baptism, marriage, funeral)
 */

const { promisePool } = require('../config/db'); // orthodmetrics_dev connection
...
/**
 * Get the main platform database connection (orthodmetrics_dev)
...
/**
 * Execute a query on the platform database (orthodmetrics_dev)
...
/**
 * Get church metadata (from orthodmetrics_dev)
 * @param {number} churchId - Church ID
