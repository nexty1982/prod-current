 ...
 * Consolidates: setup-ocr-tables.js, fix-database-tables.js, database-ma        // NOTE: Users are stored in orthodmetrics_dev, not in individual church databases
        // Church databases are for records only. User management is handled centrally.
        // Use the church_users junction table in orthodmetrics_dev to assign users to churches.enance.js
...
class DatabaseManager {
  constructor(options = {}) {
    ...
    this.dbConfig = {
      ...
      database: process.env.DB_NAME || 'orthodmetrics',
