...
'''
    ...
    for comp in sorted(components['pages'], key=lambda x: x['name']):
        comp_name = comp['name']
        comp_path = comp['path']
        report_content += f'- **{comp_name}** - `{comp_path}`\n'
    
    comp_count = len(components['components'])
    report_content += f'\n### Components ({comp_count} components)\n'
    ...
    forms_count = len(components['forms'])
    report_content += f'\n### Forms ({forms_count} components)\n'
    ...
    tables_count = len(components['tables'])
    report_content += f'\n### Tables ({tables_count} components)\n'
    ...
    modals_count = len(components['modals'])
    report_content += f'\n### Modals ({modals_count} components)\n'
    ...
    charts_count = len(components['charts'])
    report_content += f'\n### Charts ({charts_count} components)\n'
    ...
    contexts_count = len(components['contexts'])
    report_content += f'\n### Contexts ({contexts_count} components)\n'
    ...
    hooks_count = len(components['hooks'])
    report_content += f'\n### Hooks ({hooks_count} components)\n'
    ...
    utils_count = len(components['utils'])
    report_content += f'\n### Utils ({utils_count} components)\n'
    ...
    report_content += f'\n### Services ({services_count} components)\n'
    ...
    types_count = len(components['types'])
    report_content += f'\n### Types ({types_count} components)\n'
    ...
    constants_count = len(components['constants'])
    report_content += f'\n### Constants ({constants_count} components)\n'
    ...
    layouts_count = len(components['layouts'])
    report_content += f'\n### Layouts ({layouts_count} components)\n'
    ...
    auth_count = len(components['auth'])
    report_content += f'\n### Auth ({auth_count} components)\n'
    ...
    records_count = len(components['records'])
    report_content += f'\n### Records ({records_count} components)\n'
    ...
    church_count = len(components['church'])
    report_content += f'\n### Church ({church_count} components)\n'
    ...
    admin_count = len(components['admin'])
    report_content += f'\n### Admin ({admin_count} components)\n'
    ...
    other_count = len(components['other'])
    report_content += f'\n### Other ({other_count} components)\n'
    ...
    phase1_count = len(phases['phase1_core']['components'])
    report_content += f'''
## Migration Phases

### Phase 1: Core Infrastructure ({phase1_count} components)
...
'''
    ...
    phase2_count = len(phases['phase2_shared']['components'])
    report_content += f'''
### Phase 2: Shared Components ({phase2_count} components)
...
'''
    ...
    phase3_count = len(phases['phase3_features']['components'])
    report_content += f'''
### Phase 3: Feature Components ({phase3_count} components)
...
'''
    ...
    phase4_count = len(phases['phase4_pages']['components'])
    report_content += f'''
### Phase 4: Pages and Routes ({phase4_count} components)
