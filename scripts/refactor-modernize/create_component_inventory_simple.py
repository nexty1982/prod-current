...
def main():
    ...
    phase1_count = len(phases.get("phase1_core", {}).get("components", []))
    phase2_count = len(phases.get("phase2_shared", {}).get("components", []))
    phase3_count = len(phases.get("phase3_features", {}).get("components", []))
    phase4_count = len(phases.get("phase4_pages", {}).get("components", []))
    
    print(f'  Phase 1 (Core): {phase1_count} components')
    print(f'  Phase 2 (Shared): {phase2_count} components')
    print(f'  Phase 3 (Features): {phase3_count} components')
    print(f'  Phase 4 (Pages): {phase4_count} components')
...
if __name__ == "__main__":
    ...
    print(f'  Inventory file: .refactor/inventory.json')
