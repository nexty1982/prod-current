...
-- Purpose: Clean orphaned user references before adding FKs to orthodoxmetrics_auth_db.users(id).
...
LEFT JOIN orthodoxmetrics_auth_db.users u ON u.id = t.actor_id
WHERE t.actor_id IS NOT NULL AND u.id IS NULL;
SELECT 'activity_feed.user_id' AS ref, COUNT(*) AS orphan_count
FROM orthodoxmetrics_db.activity_feed t
LEFT JOIN orthodoxmetrics_auth_db.users u ON u.id = t.user_id
...
LEFT JOIN orthodoxmetrics_auth_db.users u ON u.id = t.created_by
WHERE t.created_by IS NOT NULL AND u.id IS NULL;
SELECT 'admin_settings.updated_by' AS ref, COUNT(*) AS orphan_count
FROM orthodoxmetrics_db.admin_settings t
LEFT JOIN orthodoxmetrics_auth_db.users u ON u.id = t.updated_by
...
LEFT JOIN orthodoxmetrics_auth_db.users u ON u.id = t.requested_by
...
LEFT JOIN orthodoxmetrics_auth_db.users u ON u.id = t.triggered_by
...
LEFT JOIN orthodoxmetrics_auth_db.users u ON u.id = t.blog_owner_id
WHERE t.blog_owner_id IS NOT NULL AND u.id IS NULL;
SELECT 'blog_access_requests.requester_id' AS ref, COUNT(*) AS orphan_count
FROM orthodoxmetrics_db.blog_access_requests t
LEFT JOIN orthodoxmetrics_auth_db.users u ON u.id = t.requester_id
...
LEFT JOIN orthodoxmetrics_auth_db.users u ON u.id = t.sender_id
...
LEFT JOIN orthodoxmetrics_auth_db.users u ON u.id = t.addressee_id
...
LEFT JOIN orthodoxmetrics_auth_db.users u ON u.id = t.invited_by
...
LEFT JOIN orthodoxmetrics_auth_db.users u ON u.id = t.assigned_to
...
LEFT JOIN orthodoxmetrics_auth_db.users u ON u.id = t.uploaded_by
...
LEFT JOIN orthodoxmetrics_auth_db.users u ON u.id = t.shared_by
WHERE t.shared_by IS NOT NULL AND u.id IS NULL;
SELECT 'note_shares.shared_with_user_id' AS ref, COUNT(*) AS orphan_count
FROM orthodoxmetrics_db.note_shares t
LEFT JOIN orthodoxmetrics_auth_db.users u ON u.id = t.shared_with_user_id
