...
-- Purpose: Repoint all remaining FKs from orthodoxmetrics_db._users_legacy -> orthodoxmetrics_auth_db.users(id)
...
ALTER DATABASE orthodoxmetrics_auth_db CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
ALTER TABLE orthodoxmetrics_db.activity_feed
  ...
  REFERENCES orthodoxmetrics_auth_db.users(id)
