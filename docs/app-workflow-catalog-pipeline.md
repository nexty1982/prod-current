...
**Status:** Phase B B-PR1–13 shipped; product decisions recorded 2026-06-13 — see [open questions](./workflow-catalog-open-questions.md) and [implementation plan](./workflow-catalog-decisions-implementation-plan.md)  
