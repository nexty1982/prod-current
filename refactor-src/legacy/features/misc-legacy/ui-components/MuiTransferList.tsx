...
import BasicTransferList from '@/shared/ui/mui/transfer-list/BasicTransferList';
import EnhancedTransferList from '@/shared/ui/mui/transfer-list/EnhancedTransferList';

import BasicTransferListCode from '@/shared/ui/mui/transfer-list/code/BasicTransferListCode';
import EnhancedTransferListCode from '@/shared/ui/mui/transfer-list/code/EnhancedTransferListCode';
