...
// components
import AccountTab from '@/features/misc-legacy/apps/account-settings/AccountTab';
import { IconArticle, IconBell, IconLock, IconUserCircle } from '@tabler/icons-react';
import BlankCard from '@/shared/ui/BlankCard';
import NotificationTab from '@/features/misc-legacy/apps/account-settings/NotificationTab';
import BillsTab from '@/features/misc-legacy/pages/account-setting/BillsTab';
import SecurityTab from '@/features/misc-legacy/apps/account-settings/SecurityTab';
