...
import DoughnutChartsCode from '@/features/analytics/charts/Doughnut Charts/code/DoughnutChartsCode';
import PieChartsCode from '@/features/analytics/charts/Pie Charts/code/PieChartsCode';
