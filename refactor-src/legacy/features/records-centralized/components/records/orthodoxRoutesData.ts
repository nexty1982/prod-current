...
const generateRoutesData = (): RoutesDataset => {
  const routes: RouteData[] = [
    ...
    { path: '/api/admin/shared/ui/legacy/:id', method: 'PATCH', file: 'server/routes/admin/components.js', domain: 'admin', tags: ['components', 'toggle'], description: 'Toggle component status' },
    { path: '/api/admin/shared/ui/legacy/:id/logs', method: 'GET', file: 'server/routes/admin/components.js', domain: 'admin', tags: ['components', 'logs'], description: 'Get component logs' },
    { path: '/api/admin/shared/ui/legacy/:id/test', method: 'POST', file: 'server/routes/admin/components.js', domain: 'admin', tags: ['components', 'testing'], description: 'Test component health' },
