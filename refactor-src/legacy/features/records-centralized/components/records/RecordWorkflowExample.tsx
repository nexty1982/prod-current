...
import RecordGenerator from '@/features/misc-legacy/RecordGenerator';
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-4">
                ...
                <div className="space-y-2">
                  <a 
                    href="/../features/records/records/baptism" 
                    className="block text-blue-600 dark:text-blue-400 hover:underline"
                  >
                    → Baptism Records
                  </a>
                  <a 
                    href="/../features/records/records/marriage" 
                    className="block text-blue-600 dark:text-blue-400 hover:underline"
                  >
                    → Marriage Records
                  </a>
                  <a 
                    href="/../features/records/records/funeral" 
                    className="block text-blue-600 dark:text-blue-400 hover:underline"
                  >
                    → Funeral Records
                  </a>
