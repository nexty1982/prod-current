...
import { initializeOrthodoxRoutesData, generateRoutesData } from '../../../data/orthodoxRoutesData.ts';
...
const ApiRoutesViewer = () => {
  ...
  const getComponentMapping = useCallback((route) => {
    ...
    if (path.includes('/../features/records/records/') || path.includes('baptism') || path.includes('marriage') || path.includes('funeral')) {
