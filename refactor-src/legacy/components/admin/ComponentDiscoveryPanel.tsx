...
const ComponentDiscoveryPanel: React.FC<ComponentDiscoveryPanelProps> = ({
  ...
  const loadDiscoveryResults = async () => {
    try {
      ...
      const response = await fetch('/api/shared/ui/legacy/list');
  ...
  const runDiscovery = async () => {
    try {
      ...
      const response = await fetch('/api/shared/ui/legacy/discover', {
        method: 'POST',
        headers: {
  ...
  const refreshDiscovery = async () => {
    try {
      ...
      const response = await fetch('/api/shared/ui/legacy/refresh', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json'
        }
