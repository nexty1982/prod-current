...
// Temporary: Disable notification API calls until backend is implemented
const ENABLE_NOTIFICATION_API = false;
...
export const NotificationProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
    ...
    const fetchNotifications = useCallback(async (options = {}) => {
        ...
        if (!ENABLE_NOTIFICATION_API) {
            console.log("Notification API disabled - using defaults");
            setNotifications([]);
            setLoading(false);
            return;
        }
