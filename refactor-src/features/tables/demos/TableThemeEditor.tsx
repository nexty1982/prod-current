...
import ColorPaletteSelector from '@/legacy/features/misc-legacy/ColorPaletteSelector';
import TableControlPanel from '@/legacy/features/tables/TableControlPanel';
import { ThemedTable } from '@/legacy/shared/ui/legacy/ThemedTable';
