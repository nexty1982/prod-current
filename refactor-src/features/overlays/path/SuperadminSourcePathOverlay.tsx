...
const SuperadminSourcePathOverlay: React.FC<SuperadminSourcePathOverlayProps> = () => {
  ...
  const getSourcePath = (routePath: string): string => {
    const pathMappings: Record<string, string> = {
      ...
      '/records': 'src/features/records-centralized/components/records/DynamicRecordsManager.tsx',
      '/records/baptism': 'src/features/records-centralized/components/baptism/BaptismRecordsPage.tsx',
      '/records/marriage': 'src/features/records-centralized/components/marriage/MarriageRecordsPage.tsx',
      '/records/death': 'src/features/records-centralized/components/death/DeathRecordsPage.tsx',
      '/records/communion': 'src/features/records-centralized/components/communion/CommunionRecordsPage.tsx',
      '/records/confirmation': 'src/features/records-centralized/components/confirmation/ConfirmationRecordsPage.tsx',
      '/records/census': 'src/features/records-centralized/components/census/CensusRecordsPage.tsx',
      '/records/members': 'src/features/records-centralized/components/members/MembersRecordsPage.tsx',
    ...
    if (routePath.match(/^\/records\/\w+$/)) {
      return 'src/features/records-centralized/components/DynamicRecordsPage.tsx';
    }

    if (routePath.match(/^\/account\//)) {
      return 'src/features/account/components/AccountSubPage.tsx';
    }

    if (routePath.match(/^\/admin\//)) {
      return 'src/features/admin/pages/AdminPage.tsx';
    }
